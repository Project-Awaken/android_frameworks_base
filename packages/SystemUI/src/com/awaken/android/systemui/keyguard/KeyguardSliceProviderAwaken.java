package com.awaken.android.systemui.keyguard;
...
public class KeyguardSliceProviderAwaken extends KeyguardSliceProvider implements SmartSpaceUpdateListener {
    ...
    private static class AddShadowTask extends AsyncTask<Bitmap, Void, Bitmap> {
        ...
        private final WeakReference<KeyguardSliceProviderAwaken> mProviderReference;
        private final SmartSpaceCard mWeatherCard;

        AddShadowTask(KeyguardSliceProviderAwaken keyguardSliceProviderAwaken, SmartSpaceCard smartSpaceCard) {
            mProviderReference = new WeakReference<>(keyguardSliceProviderAwaken);
            mWeatherCard = smartSpaceCard;
            mBlurRadius = keyguardSliceProviderAwaken.getContext().getResources().getDimension(R.dimen.smartspace_icon_shadow);
        }
        ...
        public void onPostExecute(Bitmap bitmap) {
            KeyguardSliceProviderAwaken keyguardSliceProviderAwaken;
            synchronized (this) {
                mWeatherCard.setIcon(bitmap);
                keyguardSliceProviderAwaken = (KeyguardSliceProviderAwaken) mProviderReference.get();
            }
            if (keyguardSliceProviderAwaken != null) {
                keyguardSliceProviderAwaken.notifyChange();
            }
        }
    ...
    public Slice onBindSlice(Uri uri) {
        Trace.beginSection("KeyguardSliceProviderAwaken#onBindSlice");
        Slice slice;
