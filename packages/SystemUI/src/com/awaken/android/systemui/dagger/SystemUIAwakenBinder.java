...
import com.awaken.android.systemui.gamedashboard.GameMenuActivityWrapper;
...
public abstract class SystemUIAwakenBinder {
    /**
    ...
    public abstract SystemUI bindThemeOverlayController(ThemeOverlayControllerAwaken sysui);
