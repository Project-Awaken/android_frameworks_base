...
public class PropImitationHooks {
    ...
    public static void setProps(Context context) {
        ...
        } else if (sSpoofGapps && (packageName.equals(PACKAGE_AIWALLPAPERS) || packageName.equals(PACKAGE_AICORE) || packageName.equals(PACKAGE_ASI)
                || packageName.equals(PACKAGE_ASSISTANT) || packageName.equals(PACKAGE_EMOJIWALLPAPER) || packageName.equals(PACKAGE_GBOARD)
                || packageName.equals(PACKAGE_GEMINI) || packageName.equals(PACKAGE_LIVEWALLPAPER) || packageName.equals(PACKAGE_PIXELTHEMES)
